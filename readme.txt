...
Step 3: To run Program
	...
	5. Copy file command.js to folder: cypress/support
	6. Run command: npm start
	   to start detection server
	7. Open new Terminal then run command: npm run cypress:open then choose mousecontrol.js in cypress windows
